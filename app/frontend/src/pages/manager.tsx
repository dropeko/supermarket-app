...
export default function Manager() {
  ...
  const handleSubmitNovoProduto = (e:any) => {
    e.preventDefault();
    // Lógica para adicionar o novo produto à lista de produtos em promoção
    // Você deve adicionar a lógica aqui para validar e adicionar o novo produto
    // aos produtos em promoção (produtosEmPromocao).

    // Exemplo de adição:
    setProdutosEmPromocao([...produtosEmPromocao, novoProduto]);
